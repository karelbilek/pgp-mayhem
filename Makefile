...
OBJS.bc=packet.cmo parsePGP.cmo sStream.cmo bdbwrap.cmo \
	...
	clean_keydb.cmo build.cmo fakebuild.cmo fastbuild.cmo pbuild.cmo merge_keyfiles.cmo \
...
EXEOBJS.bc=$(RSERVOBJS.bc) build.cmo fakebuild.cmo fastbuild.cmo dbserver.cmo pdiskTest.cmo
